"use strict";
(self["webpackChunkdefra"] = self["webpackChunkdefra"] || []).push([["layers-CatalogDynamicGroupLayerView2D"],{
...
/* harmony import */ var _layers_CatalogDynamicGroupLayerView_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../layers/CatalogDynamicGroupLayerView.js */ "./node_modules/@arcgis/core/views/layers/CatalogDynamicGroupLayerView.js");
...
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
let i=class extends((0,_layers_CatalogDynamicGroupLayerView_js__WEBPACK_IMPORTED_MODULE_8__["default"])((0,_LayerView2D_js__WEBPACK_IMPORTED_MODULE_7__.LayerView2DMixin)(_layers_LayerView_js__WEBPACK_IMPORTED_MODULE_9__["default"]))){constructor(){super(...arguments),this.unsupportedItemTypes=["Scene Service"],this.layerViews=new _core_Collection_js__WEBPACK_IMPORTED_MODULE_1__["default"]}attach(){this.addAttachHandles([this.layerViews.on("after-changes",(()=>this._updateStageChildren())),this.enableLayerUpdates()])}detach(){this.container.removeAllChildren()}update(e){this.updateLayers()}viewChange(){}moveEnd(){this.requestUpdate()}_updateStageChildren(){this.container.removeAllChildren(),this.layerViews.forEach(((e,r)=>this.container.addChildAt(e.container,r)))}};i=(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_subclass_js__WEBPACK_IMPORTED_MODULE_6__.subclass)("esri.views.2d.layers.CatalogDynamicGroupLayerView2D")],i);const c=i;
...
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
const l=Symbol(),u=u=>{let y=class extends u{constructor(){super(...arguments),this.layerViews=new _core_Collection_js__WEBPACK_IMPORTED_MODULE_1__["default"],this._debouncedUpdate=(0,_core_promiseUtils_js__WEBPACK_IMPORTED_MODULE_4__.debounce)((async()=>{const{layer:e,parent:r}=this,t=r?.footprintLayerView;let s=[];const i=this._createQuery();if(i&&t){const{features:r}=await t.queryFeatures(i);this.suspended||(s=r.map((r=>e.acquireLayer(r))))}this.removeHandles(l),this.addHandles(s,l)}))}get creatingLayerViews(){return this.view?.layerViewManager.isCreatingLayerViewsForLayer(this.layer)??!1}isUpdating(){return this.creatingLayerViews||this.layer.updating||this.layerViews.some((e=>e.updating))}enableLayerUpdates(){return (0,_core_handleUtils_js__WEBPACK_IMPORTED_MODULE_2__.handlesGroup)([this._updatingHandles.addWhen((()=>!1===this.parent?.footprintLayerView?.dataUpdating),(()=>this.updateLayers())),this._updatingHandles.add((()=>[this.layer.maximumVisibleSublayers,this.layer.parent?.orderBy,this.parent?.footprintLayerView?.filter,this.parent?.footprintLayerView?.timeExtent,this.suspended]),(()=>this.updateLayers())),(0,_core_handleUtils_js__WEBPACK_IMPORTED_MODULE_2__.makeHandle)((()=>this.removeHandles(l)))])}updateLayers(){this.suspended?this.removeHandles(l):this._updatingHandles.addPromise((0,_core_promiseUtils_js__WEBPACK_IMPORTED_MODULE_4__.ignoreAbortErrors)(this._debouncedUpdate()).catch((e=>{_core_Logger_js__WEBPACK_IMPORTED_MODULE_3__["default"].getLogger(this).error(e)})))}_createQuery(){const e=this.parent?.footprintLayerView,r=this.layer?.parent;if(!e||!r||r.destroyed)return null;const{layer:{maximumVisibleSublayers:t},view:{scale:s}}=this;if(!t)return null;const{itemTypeField:i,itemSourceField:a,itemNameField:o,minScaleField:d,maxScaleField:p,objectIdField:l,orderBy:u}=r,y=(0,_core_sql_js__WEBPACK_IMPORTED_MODULE_5__.sqlAnd)(`${d} IS NULL OR ${s} <= ${d} OR ${d} = 0`,`${p} IS NULL OR ${s} >= ${p}`),c=u?.find((e=>e.field&&!e.valueExpression)),m=e.createQuery();if(m.returnGeometry=!1,m.num=t,m.outFields=[l,a,o],m.where=(0,_core_sql_js__WEBPACK_IMPORTED_MODULE_5__.sqlAnd)(m.where,y),null!=this.unsupportedItemTypes){const e=`${i} NOT IN (${this.unsupportedItemTypes.map((e=>`'${e}'`))})`;m.where=(0,_core_sql_js__WEBPACK_IMPORTED_MODULE_5__.sqlAnd)(m.where,e)}return c?.field&&(m.orderByFields=[`${c.field} ${"descending"===c.order?"DESC":"ASC"}`],m.outFields.push(c.field)),m}};return (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_6__.property)({readOnly:!0})],y.prototype,"creatingLayerViews",null),(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_6__.property)()],y.prototype,"layer",void 0),(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_6__.property)()],y.prototype,"layerViews",void 0),(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_6__.property)({readOnly:!0})],y.prototype,"unsupportedItemTypes",void 0),(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_6__.property)()],y.prototype,"parent",void 0),(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_6__.property)({readOnly:!0})],y.prototype,"isUpdating",null),y=(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_subclass_js__WEBPACK_IMPORTED_MODULE_9__.subclass)("esri.views.layers.CatalogDynamicGroupLayerView")],y),y};
...
//# sourceMappingURL=layers-CatalogDynamicGroupLayerView2D.js.map