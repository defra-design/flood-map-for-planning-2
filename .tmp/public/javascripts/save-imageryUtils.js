"use strict";
(self["webpackChunkdefra"] = self["webpackChunkdefra"] || []).push([["save-imageryUtils"],{
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   save: function() { return /* binding */ g; },
/* harmony export */   saveAs: function() { return /* binding */ v; }
/* harmony export */ });
...
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
const l="Image Service",y="imagery-layer-save",n="imagery-layer-save-as",o="imagery-tile-layer-save",m="imagery-tile-layer-save-as";function c(e){if("imagery"===e.type)return{isValid:!0};const{raster:t}=e,r="Function"===t?.datasetFormat?t.primaryRasters?.rasters[0]:t;return{isValid:"RasterTileServer"===r?.datasetFormat&&("Raster"===r.tileType||"Map"===r.tileType),errorMessage:"imagery tile layer should be created from a tiled image service."}}function p(e){const t=e.layerJSON;return Promise.resolve(t&&Object.keys(t).length?t:null)}async function u(e,t){const{parsedUrl:l,title:y,fullExtent:n}=e;t.url=l.path,t.title||=y;try{t.extent=await (0,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_1__.getWGS84ExtentForItem)(n)}catch{t.extent=void 0}(0,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_1__.removeTypeKeyword)(t,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_1__.typeKeyword.METADATA),(0,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_1__.toggleTypeKeyword)(t,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_1__.typeKeyword.TILED_IMAGERY,"imagery-tile"===e.type)}async function g(t,r){const a="imagery"===t.type?y:o;return (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.save)({layer:t,itemType:l,validateLayer:c,createItemData:p,errorNamePrefix:a},r)}async function v(e,r,a){const i="imagery"===e.type?n:m;return (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.saveAs)({layer:e,itemType:l,validateLayer:c,createItemData:p,errorNamePrefix:i,newItem:r,setItemProperties:u},a)}
