"use strict";
(self["webpackChunkdefra"] = self["webpackChunkdefra"] || []).push([["layers-CatalogLayerView2D"],{
...
/* harmony import */ var _layers_CatalogLayerView_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../layers/CatalogLayerView.js */ "./node_modules/@arcgis/core/views/layers/CatalogLayerView.js");
...
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
let l=class extends((0,_layers_CatalogLayerView_js__WEBPACK_IMPORTED_MODULE_8__["default"])((0,_LayerView2D_js__WEBPACK_IMPORTED_MODULE_7__.LayerView2DMixin)(_layers_LayerView_js__WEBPACK_IMPORTED_MODULE_9__["default"]))){constructor(){super(...arguments),this.layerViews=new _core_Collection_js__WEBPACK_IMPORTED_MODULE_1__["default"]}update(e){}viewChange(){}moveEnd(){}attach(){this.addAttachHandles([this._updatingHandles.addOnCollectionChange((()=>this.layerViews),(()=>this._updateStageChildren()),{initial:!0})])}detach(){this.container.removeAllChildren()}_updateStageChildren(){this.container.removeAllChildren(),this.layerViews.forEach(((e,r)=>this.container.addChildAt(e.container,r)))}};(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_2__.property)()],l.prototype,"layerViews",void 0),l=(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_subclass_js__WEBPACK_IMPORTED_MODULE_6__.subclass)("esri.views.2d.layers.CatalogLayerView2D")],l);const c=l;
...
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
const i=i=>{let s=class extends i{constructor(...r){super(...r),this.layerViews=new _core_Collection_js__WEBPACK_IMPORTED_MODULE_1__["default"]}get dynamicGroupLayerView(){return this.layerViews.find((r=>r.layer===this.layer?.dynamicGroupLayer))}get footprintLayerView(){return this.layerViews.find((r=>r.layer===this.layer?.footprintLayer))}isUpdating(){return!this.dynamicGroupLayerView||!this.footprintLayerView||this.dynamicGroupLayerView.updating||this.footprintLayerView.updating}};return (0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_2__.property)()],s.prototype,"layer",void 0),(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_2__.property)()],s.prototype,"layerViews",void 0),(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_2__.property)({readOnly:!0})],s.prototype,"dynamicGroupLayerView",null),(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_2__.property)({readOnly:!0})],s.prototype,"footprintLayerView",null),s=(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_subclass_js__WEBPACK_IMPORTED_MODULE_6__.subclass)("esri.views.layers.CatalogLayerView")],s),s};
...
//# sourceMappingURL=layers-CatalogLayerView2D.js.map