"use strict";
(self["webpackChunkdefra"] = self["webpackChunkdefra"] || []).push([["rest-query-executeForTopExtents"],{
...
/* harmony export */   executeForTopExtents: function() { return /* binding */ a; }
/* harmony export */ });
...
*/
async function a(a,m,n){const s=(0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.parseUrl)(a),i=await (0,_operations_queryTopFeatures_js__WEBPACK_IMPORTED_MODULE_2__.executeQueryForTopExtents)(s,_support_TopFeaturesQuery_js__WEBPACK_IMPORTED_MODULE_3__["default"].from(m),{...n}),u=i.data.extent;return!u||isNaN(u.xmin)||isNaN(u.ymin)||isNaN(u.xmax)||isNaN(u.ymax)?{count:i.data.count,extent:null}:{count:i.data.count,extent:_geometry_Extent_js__WEBPACK_IMPORTED_MODULE_4__["default"].fromJSON(u)}}
...
//# sourceMappingURL=rest-query-executeForTopExtents.js.map