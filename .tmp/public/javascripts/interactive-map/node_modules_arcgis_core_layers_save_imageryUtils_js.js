 ...
 */
(self["webpackChunkfmfp"] = self["webpackChunkfmfp"] || []).push([["node_modules_arcgis_core_layers_save_imageryUtils_js"],{
...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   save: function() { return /* binding */ I; },\n/* harmony export */   saveAs: function() { return /* binding */ h; }\n/* harmony export */ });\n/* harmony import */ var _raster_datasets_datasetUtils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../raster/datasets/datasetUtils.js */ \"./node_modules/@arcgis/core/layers/raster/datasets/datasetUtils.js\");\n/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils.js */ \"./node_modules/@arcgis/core/layers/save/utils.js\");\n/* harmony import */ var _portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../portal/support/portalItemUtils.js */ \"./node_modules/@arcgis/core/portal/support/portalItemUtils.js\");\n/* COPYRIGHT Esri - https://js.arcgis.com/5.1.13/LICENSE.txt */\nconst y=\"Image Service\",n=\"imagery-layer-save\",o=\"imagery-layer-save-as\",m=\"imagery-tile-layer-save\",c=\"imagery-tile-layer-save-as\",p=\"WCS\",g=\"wcs-layer-save\",u=\"wcs-layer-save-as\";function v(t){if(\"imagery\"===t.type||\"wcs\"===t.type)return{isValid:!0};const{raster:r}=t,a=(0,_raster_datasets_datasetUtils_js__WEBPACK_IMPORTED_MODULE_0__.getPrimaryRasters)(r)[0];return{isValid:\"RasterTileServer\"===a?.datasetFormat&&(\"Raster\"===a.tileType||\"Map\"===a.tileType),errorMessage:\"imagery tile layer should be created from a tiled image service.\"}}function f(e){const t=e.layerJSON;return Promise.resolve(t&&Object.keys(t).length?t:null)}function d(e,t){(0,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_2__.toggleTypeKeyword)(t,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_2__.typeKeyword.CHARTS,!!e.charts?.length)}async function T(e,t){const{parsedUrl:r,title:y,fullExtent:n}=e;t.url=r.path,t.title||=y;try{t.extent=await (0,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_2__.getWGS84ExtentForItem)(n)}catch{t.extent=void 0}(0,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_2__.removeTypeKeyword)(t,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_2__.typeKeyword.METADATA),(0,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_2__.toggleTypeKeyword)(t,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_2__.typeKeyword.TILED_IMAGERY,\"imagery-tile\"===e.type),(0,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_2__.toggleTypeKeyword)(t,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_2__.typeKeyword.CHARTS,!!e.charts?.length)}async function I(e,t){const a=\"imagery\"===e.type?n:\"imagery-tile\"===e.type?m:g,s=\"wcs\"===e.type?p:y;return (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.save)({layer:e,itemType:s,validateLayer:v,createItemData:f,errorNamePrefix:a,setItemProperties:d},t)}async function h(e,r,a){const s=\"imagery\"===e.type?o:\"imagery-tile\"===e.type?c:u,i=\"wcs\"===e.type?p:y;return (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.saveAs)({layer:e,itemType:i,validateLayer:v,createItemData:f,errorNamePrefix:s,newItem:r,setItemProperties:T},a)}\n\n\n//# sourceURL=webpack://fmfp/./node_modules/@arcgis/core/layers/save/imageryUtils.js?\n}");
